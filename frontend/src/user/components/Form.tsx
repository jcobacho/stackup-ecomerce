...
function UserForm({userFormData, setUserFormData, userFormErrors, isCreating}) {

    return ( 

        <>
            <FormControl isRequired={true} isInvalid={Object.keys(userFormErrors).length > 0 ? true : false }>
